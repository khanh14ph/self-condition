...
def speech_file_to_array_fn(batch):
    ...
    batch["target_text_phoneme"] = (
        batch["phoneme_transcript"] if batch["phoneme_transcript"] is not None else "<unk>"
    )
...
model = Wav2Vec2ForCTCSelfCondPhoneme.from_pretrained(
